 ...
 *  means if (i >= 0) ? print 1 :else print -1. So therefore when i is 17, 17 is printed
 *  as 17 is greater than or equal to 0. However if the value of i is -17 it prints 17
